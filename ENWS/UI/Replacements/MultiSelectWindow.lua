...
print(msgHeader .. "Loading modified MultiSelectWindow.lua . . .");
...
function InitNaturalWonderCountSlider()
	...
	Controls.CityStateCountNumber:SetText(currentNW);
	Controls.CityStateCountSlider:SetNumSteps(maximumNW - minimumNW);
	Controls.CityStateCountSlider:SetStep(currentNW - minimumNW);
