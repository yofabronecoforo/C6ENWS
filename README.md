...
- Mods that make extensive changes to the AdvancedSetup and/or HostGame XML templates are not supported by ENWS. Notably, this applies to Sukitract's Civ Selection Screen.
